...
struct Arrow: Shape {
    func path(in rect: CGRect) -> Path {
        var path = Path()
        let difference = rect.width * 0.15
        
        path.addLines([
            CGPoint(x: ((rect.midX - difference)/2) , y: 0),
            CGPoint(x:  rect.midX + ((rect.midX - difference)/2), y: 0),
            CGPoint(x: rect.width - difference, y: rect.midY),
            CGPoint(x:  rect.midX + ((rect.midX - difference)/2), y: rect.height),
            CGPoint(x: ((rect.midX - difference)/2) , y: rect.height),
            CGPoint(x: ((rect.midX - difference)/2) + difference , y: rect.midY),
